...
import { Home, DollarSign, LogOut, User, Book, Paintbrush, AlertTriangle, KeyRound, Video, MessageSquare, Clock } from "lucide-react"; // Added Video icon, MessageSquare, Clock
...
const navItems: Array<{
  ...
  { to: "/parent-timetable", label: "Timetable", icon: Clock, role: 'parent' as const },

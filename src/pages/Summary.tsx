...
import { Tooltip, TooltipProvider, TooltipTrigger, TooltipContent } from "@/components/ui/tooltip"; // Ensure named imports
                          ...
                          {student.absentDates.length > 3 ? (
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <div className="cursor-pointer text-sm text-blue-600 underline">
                                  {student.absentDates
                                    .slice(0, 3)
                              ...
                              <TooltipContent className="bg-gray-800 text-white p-2 rounded shadow-lg max-w-xs max-h-32 overflow-y-auto">
